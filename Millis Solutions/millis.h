...
'
'  Copyright (C) 2018-2019 Chris Roper
...
'*********************************************************
'
'why not use a constant to set Tmr0InitVal? when folks have issues we can tell people to change this in the user program when the oscillator is not correctly setup.
#define Millis_Default_Timer0_value 6

'the chipfamily check could be removed - I dont think it add anything. I just added. You can remove.
