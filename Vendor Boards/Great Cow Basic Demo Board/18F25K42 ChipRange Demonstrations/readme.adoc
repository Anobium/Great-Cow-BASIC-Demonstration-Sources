*The I2C Challenge for the new I2C Module for Great Cow BASIC*
...
For Great Cow BASIC a reference implementation is required to support 'legacy mode'.
...
The Great Cow BASIC implementation generates as transmission as shown below. This is a correct I2C packet
transmission.
